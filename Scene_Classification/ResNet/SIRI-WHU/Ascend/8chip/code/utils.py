...
def create_dataset(dataset_path, do_train, batch_size=16, num_shards=1, shard_id=0, shuffle=False):
    """
    ...
    ds = de.ImageFolderDataset(dataset_path, num_parallel_workers=min(8, num_parallel_workers), shuffle=shuffle,num_shards=num_shards, shard_id=shard_id)
    # else:
