...
if __name__ == '__main__':
    ...
    parser.add_argument('-i','--input_file', type=str, default="./test/Farmland/Farmland_version1_2.jpg", help='Input file path')
    parser.add_argument('-o','--output_folder', type=str, default="./output", help='Output file path')
    parser.add_argument('-c1','--checkpoint_path', type=str, default="./checkpoint/model/net-500_12.ckpt", help='Saved checkpoint file path')
