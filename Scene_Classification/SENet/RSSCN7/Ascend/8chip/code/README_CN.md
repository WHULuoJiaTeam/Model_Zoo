...
使用的数据集：[RSSCN7](https://sites.google.com/site/qinzoucn/documents)  
支持的数据集：[RSSCN7]或与RSSCN7格式相同的数据集
...
└─SENet
  ...
  ├─Resnet_se.py                    # Resnet_se网络模型
  ├─SEblock.py                      # SEblock模块
  ├─config.py                       # 模型设置
