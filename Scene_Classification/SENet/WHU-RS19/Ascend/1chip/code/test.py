...
if __name__ == '__main__':
    ...
    parser.add_argument('-i','--input_file', type=str, default="test/Beach/Beach_version1_4.jpg", help='Input file path')
    parser.add_argument('-o','--output_folder', type=str, default="output", help='Output file path')
    parser.add_argument('-c1','--checkpoint_path', type=str, default="checkpoint/model/net_2-350_12.ckpt", help='Saved checkpoint file path')
    parser.add_argument('-c2','--classes_file', type=str, default="class.txt", help='Classes saved txt path ')
    ...
    net = se_resnet18(len(class_name)) # 网路模型
