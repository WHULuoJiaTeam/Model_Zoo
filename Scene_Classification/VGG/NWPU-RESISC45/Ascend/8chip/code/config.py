...
config = ed({
    ...
    "dataset_path": "obs://sktest/NWPU-RESISC45_train/",  #数据存放位置
    "dataset_eval_path": "obs://sktest/NWPU-RESISC45_test/",  #验证数据存放位置
    "save_checkpoint_path": "/cache/training/",  #保存的参数存放位置
    "obs_checkpoint_path":"obs://luojianet-benchmark/Scene_Classification/VGG-16/NWPU-RESISC45/8chip/ckpt/",# obs ckpt存放位置
    ...
    "keep_checkpoint_max": 50, #文件内保存模型的最大个数，超过则删掉最开始的
