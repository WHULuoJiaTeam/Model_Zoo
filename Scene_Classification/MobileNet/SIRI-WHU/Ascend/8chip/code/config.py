...
config = ed({
    ...
    "dataset_path": "obs://sktest/SIRI-WHU_train/",  #数据存放位置
    "dataset_eval_path": "obs://sktest/SIRI-WHU_test/",  #验证数据存放位置
    "save_checkpoint_path": "/cache/training/",  #保存的参数存放位置
    "obs_checkpoint_path":"obs://luojianet-benchmark/Scene_Classification/MobileNet/SIRI-WHU/8chip/ckpt/",# obs ckpt存放位置
