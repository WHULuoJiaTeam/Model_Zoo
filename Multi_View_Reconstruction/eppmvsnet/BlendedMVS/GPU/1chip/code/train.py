...
if __name__ == "__main__":
    args = get_opts()
    context.set_context(mode=1, device_target='CPU', device_id=args.gpu_id, save_graphs=False,
    ...
    ckpoint_cb = ModelCheckpoint(prefix="checkpoint_eppmvsnet_whu", directory="checkpoint", config=config_ck)
    time_cb = TimeMonitor()
