...
class UNet2D(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv2dbackpropinput_51 = nn.Conv2dTranspose(128, 64, 3, stride=2, padding=0, pad_mode="same")

        self.conv2d_54 = nn.Conv2d(128, 64, 3, stride=1, padding=1, pad_mode="pad")
        self.convblockb_3 = BasicBlockB(64, 64)

        self.conv2dbackpropinput_62 = nn.Conv2dTranspose(64, 32, 3, stride=2, padding=0, pad_mode="same")
