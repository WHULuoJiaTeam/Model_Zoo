...
def infer(model_path, data_path):
    ...
    print('load test weights from ', str(model_path))
    load_param_into_net(model, load_checkpoint(model_path))
    print('loaded test weights from ', str(model_path))
