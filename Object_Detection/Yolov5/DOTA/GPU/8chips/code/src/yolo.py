...
class YOLOV5(nn.Module):
    ...
    def forward(self, x, input_shape):
        ...
        # print('forward info: big:{}, me:{}, small:{}'.format(output_big, output_me, output_small))
...
class YoloWithLossCell(nn.Module):
    ...
    # def forward(self, x, anno,  y_true_0, y_true_1, y_true_2, gt_0, gt_1, gt_2):
    #     input_shape = x.shape[2:4]
