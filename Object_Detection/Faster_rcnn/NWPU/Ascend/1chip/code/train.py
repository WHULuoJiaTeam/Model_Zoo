...
def get_args():
    parser = argparse.ArgumentParser(description="fasterrcnn&maskrcnn training")
    parser.add_argument("--device_target", type=str, default="Ascend")
    parser.add_argument("--device_id", type=str, default="0")
    parser.add_argument("--device_num", type=int, default=1)
    parser.add_argument("--pre_trained", type=str, default="/home/ma-user/work/luojianet_detection_v3/pretrained_models/resnet152.ckpt")
    parser.add_argument("--coco_root", type=str, default="/home/ma-user/work/NWPU/")
    parser.add_argument("--keep_checkpoint_max", type=int, default=45)
    parser.add_argument("--epoch_size", type=int, default=50)
    parser.add_argument("--batch_size", type=int, default=2)
    parser.add_argument("--save_checkpoint_path", type=str, default="/home/ma-user/work/OUTPUT/fasterrcnn/NWPU/single/")
...
if __name__ == '__main__':
    ...
    config.device_num = args.device_num
