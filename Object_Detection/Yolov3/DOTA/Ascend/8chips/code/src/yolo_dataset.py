...
from luojianet_ms.dataset.vision.c_transforms import HWC2CHW, Decode
...
def create_yolo_dataset(image_dir, anno_path, batch_size, device_num, rank,
    ...
    if is_training:
        ...
        dataset = dataset.map(operations=hwc_to_chw, input_columns=["image"], num_parallel_workers=min(8, num_parallel_workers))
        dataset = dataset.batch(batch_size, drop_remainder=True)

    return dataset, len(yolo_dataset)
