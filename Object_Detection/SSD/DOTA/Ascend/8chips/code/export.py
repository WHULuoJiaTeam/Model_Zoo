...
from luojianet_ms.train.serialization import load_checkpoint, load_param_into_net, export
...
if __name__ == '__main__':
    ...
    input_array = Tensor(np.random.uniform(-1.0, 1.0, size=input_shp), luojianet_ms.float32)
