...
def get_args():
    ...
    parser.add_argument("--checkpoint_path", type=str, default="/home/ma-user/work/NWPU")
...
def retinanet_eval():
    ...
    for data in ds.create_dict_iterator(output_numpy=True):
        ...
        total_time_use = total_time_use + time_use
        print("this step use time:{}".format(time_use))
    ...
    print("total time use:{}".format(total_time_use))
