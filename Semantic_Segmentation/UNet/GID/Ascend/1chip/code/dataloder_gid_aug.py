...
class Dataset_RealUD:
    ...
    def __getitem__(self, index):
        ...
        imagepatch_1 = imgdata_band1.ReadAsArray(Dict_i['x'], Dict_i['y'], Dict_i['block_x'], Dict_i['block_y']).astype(
                'uint8')
        imagepatch_2 = imgdata_band2.ReadAsArray(Dict_i['x'], Dict_i['y'], Dict_i['block_x'], Dict_i['block_y']).astype(
                'uint8')
        imagepatch_3 = imgdata_band3.ReadAsArray(Dict_i['x'], Dict_i['y'], Dict_i['block_x'], Dict_i['block_y']).astype(
                'uint8')
        ...
        labelpatch_1 = labeldata_band1.ReadAsArray(Dict_i['x'], Dict_i['y'], Dict_i['block_x'],
                                                   Dict_i['block_y']).astype('uint8')
        labelpatch_2 = labeldata_band2.ReadAsArray(Dict_i['x'], Dict_i['y'], Dict_i['block_x'],
                                                   Dict_i['block_y']).astype('uint8')
        labelpatch_3 = labeldata_band3.ReadAsArray(Dict_i['x'], Dict_i['y'], Dict_i['block_x'],
                                                   Dict_i['block_y']).astype('uint8')
...
if __name__ == '__main__':
    ...
    dataset_generator = Dataset_RealUD(
            json_path = r'/media/vhr/0D7A09740D7A0974/zz/GID/LCC5C/LCC5C_b512_woOverlap.json',
