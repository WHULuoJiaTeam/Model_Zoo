...
def get_argparse():
    ...
    parser.add_argument('-c', '--config', type=str, default='UNet', help='Configuration File')
...
if __name__ == "__main__":
    ...
    print(os.listdir('/cache/dataset/cropped512/img/'))
    # dataset
    ...
    # upload opt to obs
    mox.file.copy_parallel('/cache/checkpoint', 'obs://luojianet-benchmark/Semantic_Segmentation/UNet/ISPRS_Vaihingen/Ascend/1chip/ckpt/')
